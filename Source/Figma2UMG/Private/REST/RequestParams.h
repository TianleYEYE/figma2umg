...
public:
	...
	UPROPERTY(EditAnywhere, meta = (Category = "Figma|Options", ToolTip = "Maximum amount of Images requested per REST request.", ClampMin = "1", ClampMax = "30", UIMin = "1", UIMax = "30"))
	int MaxURLImageRequest = 20;

	UPROPERTY(EditAnywhere, meta = (Category = "Figma|Options", ToolTip = "Delay in seconds between image URL requests to avoid rate limiting.", ClampMin = "0.0", ClampMax = "30.0", UIMin = "0.0", UIMax = "30.0"))
